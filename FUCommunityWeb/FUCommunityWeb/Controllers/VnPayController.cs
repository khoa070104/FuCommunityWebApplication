...
namespace FUCommunityWeb.Controllers
{
    public class VnPayController : Controller
    {
        ...
        public VnPayController(IConfiguration configuration, ILogger<VnPayController> logger, VnPayService vnPayService, OrderRepo orderRepository, ApplicationDbContext context)
        {
